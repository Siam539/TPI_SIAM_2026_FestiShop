{{-- Liste des utilisateurs (customers et manutentionnaires) avec CRUD --}}
            ...
            <form action="{{ route('admin.users.index') }}" method="GET">
                <div class="row g-2">
                    ...
                    <div class="col-md-2 d-flex gap-2">
                        ...
                        @if (request('name') || request('role') || request('is_active') != null)
                            <a href="{{ route('admin.users.index') }}" class="btn btn-outline-secondary flex-fill">Réinitialiser</a>
                        @endif
                    </div>
                </div>
            </form>
                    ...
                    @forelse ($users as $user)
                        <tr>
                            ...
                            <td>
                                ...
                                @elseif($user->role == 'manutentionnaire')
                                    <span class="badge bg-success">Manutentionnaire</span>
